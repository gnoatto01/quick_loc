...
import com.br.soluctions.attos.quick_loc.services.OccurrenceService;
...
public class OccurrenceController {
    ...
    @PreAuthorize("hasAuthority('SCOPE_ADMIN') || hasAuthority('SCOPE_MANAGER')|| hasAuthority('SCOPE_USER') ")
